...
- AI 인사이트: `src/hooks/useAiInsight.js` (Gemini 2.5 Flash Lite API 호출), `src/components/AiInsightCard.jsx`
...
**공통 UX**
- [x] 다크 LNB + 라이트 메인 혼합 테마 (LNB 카테고리 구분 구분선 추가)
- [x] 모바일 반응형 (768px 기준)
...
- [x] AI 인사이트 카드 (Gemini 2.5 Flash Lite) — GFP/자동차/리테일 메인 대시보드에 자연어 분석 문단 표시
- [x] 월별 추세 차트 — 자동차 보험 / 리테일 사업부 메인 대시보드
...
| FR-19 | Should | AI 인사이트 카드 — Gemini 2.5 Flash Lite로 대시보드 데이터 자연어 분석 (GFP/자동차/리테일 각 메인) | ✅ |
| FR-20 | Could | 월별 추세 차트 — 자동차 보험·리테일 사업부 메인 대시보드 | ✅ |
...
6. [x] 문서 최신화 (v2.0.0)
7. [x] AI 인사이트 카드 추가 (FR-19) — Gemini 2.5 Flash Lite, 자연어 단일 문단, 3개 대시보드
8. [x] 자동차 보험·리테일 월별 추세 차트 (FR-20)
9. [x] LNB 카테고리 구분선 + 전체 디자인시스템 통일 (v2-redesign Stage 1-5)
10. [ ] 자동차보험 계약수당 자동매칭 및 수당산출 (신규 과제 — 대표님 요청)
...
| 2.1.0 | 2026-05-15 | AI 인사이트 카드 (Gemini 2.5 Flash Lite) 추가, 월별 추세 차트 (자동차/리테일), LNB 카테고리 구분, v2-redesign 디자인시스템 통일 |
